...
#parallel --bar $codedir/run_regseg.sh $src {} ::: sub-01 sub-02 sub-03 sub-04 sub-05 sub-06 sub-07 sub-08 sub-09 sub-10
parallel --bar $codedir/run_reg.sh $src {} ::: sub-01 sub-02 sub-03 sub-04 sub-05 sub-06 sub-07 sub-08 sub-09 sub-10
parallel --bar $codedir/run_seg.sh $src {} ::: sub-01 sub-02 sub-03 sub-04 sub-05 sub-06 sub-07 sub-08 sub-09 sub-10
